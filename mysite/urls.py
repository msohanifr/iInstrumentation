...
urlpatterns = [
    ...
    path(urlsecret.SECRET_CODE + '/settings/', views.settings, name='settings'),
    ...
    path(urlsecret.SECRET_CODE + '/manage_card/', views.manage_card, name='manage_card'),
    path(urlsecret.SECRET_CODE + '/add_card/', views.add_card, name='add_card'),

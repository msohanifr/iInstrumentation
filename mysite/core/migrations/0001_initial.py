# Generated by Django 2.1.2 on 2019-08-16 21:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, help_text='Phone format is: 123-456-7890', max_length=17, validators=[django.core.validators.RegexValidator(message="Phone number must be entered in the format: '+999999999'. Up to 15 digits allowed.", regex='^[2-9]\\d{2}-\\d{3}-\\d{4}$')])),
                ('phone_verification_status', models.IntegerField(default=0)),
                ('phone_verification_code', models.CharField(blank=True, default='', max_length=6, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Service',
